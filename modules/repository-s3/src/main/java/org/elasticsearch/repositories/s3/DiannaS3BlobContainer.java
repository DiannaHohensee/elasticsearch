...
class DiannaS3BlobContainer extends AbstractBlobContainer {

    private static final Logger logger = LogManager.getLogger(DiannaS3BlobContainer.class);

    private final S3BlobStore blobStore;
    private final String keyPath;

    DiannaS3BlobContainer(BlobPath path, S3BlobStore blobStore) {
        super(path);
