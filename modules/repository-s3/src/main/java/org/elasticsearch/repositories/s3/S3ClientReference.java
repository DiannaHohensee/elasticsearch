 ...
 * counting.
 */
public class S3ClientReference extends AbstractRefCounted implements Releasable { /// TODO (Dianna): no need for this class, no shutdown.

    private final S3Client client;

    S3ClientReference(S3Client client) {
        this.client = client;
    }
