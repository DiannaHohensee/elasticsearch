...
import static org.elasticsearch.common.util.concurrent.EsExecutors.TaskTrackingConfig.DEFAULT_EXECUTION_TIME_EWMA_ALPHA;
...
public class TaskExecutionTimeTrackingEsThreadPoolExecutorTests extends ESTestCase {
    ...
    public void testExecutionEWMACalculation() throws Exception {
        ...
        TaskExecutionTimeTrackingEsThreadPoolExecutor executor = new TaskExecutionTimeTrackingEsThreadPoolExecutor(
            ...
            new EsAbortPolicy(),
            context,
            new TaskTrackingConfig(randomBoolean(), DEFAULT_EXECUTION_TIME_EWMA_ALPHA)
        );
    ...
    public void testQueueLatencyEWMACalculation() throws Exception {
        ...
        TaskExecutionTimeTrackingEsThreadPoolExecutor executor = new TaskExecutionTimeTrackingEsThreadPoolExecutor(
            ...
            new TaskTrackingConfig(
                ...
                true,
                false,
                DEFAULT_EXECUTION_TIME_EWMA_ALPHA,
    ...
    public void testGetOngoingTasks() throws Exception {
        ...
        var executor = new TaskExecutionTimeTrackingEsThreadPoolExecutor(
            ...
            new EsAbortPolicy(),
            context,
            new TaskTrackingConfig(true, DEFAULT_EXECUTION_TIME_EWMA_ALPHA)
        );
