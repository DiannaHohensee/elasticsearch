...
import static org.elasticsearch.threadpool.ThreadPool.THREAD_POOL_QUEUE_LATENCY_EWMA_ALPHA;
import static org.elasticsearch.threadpool.ThreadPool.THREAD_POOL_THREAD_UTILIZATION_EWMA_ALPHA;
...
public class DefaultBuiltInExecutorBuilders implements BuiltInExecutorBuilders {
    ...
    public Map<String, ExecutorBuilder> getBuilders(Settings settings, int allocatedProcessors) {
        ...
        final double queueLatencyEWMAAlpha = THREAD_POOL_QUEUE_LATENCY_EWMA_ALPHA.get(settings);
        final double threadUtilizationEWMAAlpha = THREAD_POOL_THREAD_UTILIZATION_EWMA_ALPHA.get(settings);
