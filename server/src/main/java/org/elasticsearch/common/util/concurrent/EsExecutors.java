...
public class EsExecutors {
    ...
    public static class TaskTrackingConfig {
        public static final double DEFAULT_EXECUTION_TIME_EWMA_ALPHA = 0.3;
        public static final double DEFAULT_QUEUE_LATENCY_EWMA_ALPHA = 0.6;
        public static final double DEFAULT_POOL_UTILIZATION_EWMA_ALPHA = 0.6;
        ...
        public static final TaskTrackingConfig DO_NOT_TRACK = new TaskTrackingConfig(
            ...
            DEFAULT_QUEUE_LATENCY_EWMA_ALPHA,
